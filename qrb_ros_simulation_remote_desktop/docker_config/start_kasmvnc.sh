...
# start kasmvnc
su $USER -c "kasmvncserver :1000 -select-de xfce -interface 0.0.0.0 -websocketPort $WEB_SOCKET_PORT -cert $HTTPS_CERT -key $HTTPS_CERT_KEY -RectThreads $VNC_THREADS"
